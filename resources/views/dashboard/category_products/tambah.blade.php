<x-app-layout>
    ...
    <div class="card shadow-sm border-0 rounded-3">
                    ...
                    <div class="card-header bg-white border-bottom py-3 d-flex justify-content-between align-items-center">
                        <h5 class="mb-0 fw-bold" style="color: #0f172a;">Tambah Kategori Baru</h5>
                        {{-- <!-- Tombol Kembali -->
                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('category-products.store') }}" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control form-control-lg fs-6" id="nama_kategori" name="name" placeholder="Contoh: Pakaian Pria" required autofocus>
